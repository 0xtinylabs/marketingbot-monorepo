/*
  ...
  - You are about to alter the column `usd_value` on the `SessionHistoryRecord` table. The data in that column could be lost. The data in that column will be cast from `Int` to `Float`.
